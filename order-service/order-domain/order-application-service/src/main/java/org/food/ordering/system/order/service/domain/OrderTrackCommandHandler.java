...
public class OrderTrackCommandHandler {
    ...
    public TrackOrderResponse trackOrder(TrackOrderQuery trackOrderQuery){
        ...
        if(orderResult.isEmpty()){
            log.warn("Could not find error with tracking id : {}", trackOrderQuery.getOrderTrackingId());
            throw new OrderNotFoundException("Could not find error with tracking id" + trackOrderQuery.getOrderTrackingId());
        }
